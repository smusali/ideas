# **Zyphra — Instant Contributor Onboarding API**
...
Open-source maintainers spend too much time onboarding new contributors. Newcomers struggle to find where to start. Zyphra solves this by providing an API that instantly generates onboarding kits and a simple Q&A bot for any public repository.
...
**Zyphra** turns every open-source repo into a welcoming, self-guided playground with a single API call, helping projects grow and thrive while generating sustainable revenue.
