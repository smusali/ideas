# **Moodify** — *Simple Mental Health Tracking CLI*
...
Moodify is a simple CLI tool that lets you track your daily mood, mental health symptoms, and wellness activities directly from your terminal. Perfect for people who want to monitor their mental health without complex tools or privacy concerns.
...
```bash
# Install via npm
npm install -g moodify-cli

# Install via pip
pip install moodify-cli

# Install via cargo
cargo install moodify-cli

# Basic usage
moodify mood 8                    # Log mood rating
moodify track --anxiety 3         # Track anxiety level
moodify activity exercise 30      # Log 30min exercise
moodify view --days 7             # View last 7 days
moodify export --format csv       # Export data
moodify stats                     # Show statistics
```
...
Create a config file at `~/.moodify/config.json`:

```json
{
  "data_path": "~/.moodify/data.json",
  "encryption_enabled": true,
