# **Sylera — OSS Project Health & Funding CLI/SDK**
...
Sylera is an open-source CLI and SDK that provides real-time analytics on project health, contributor activity, and funding. Designed for rapid development and easy publishing, it empowers maintainers to understand and grow their projects in just 7 days of work.
...
pip install sylera-cli
# or
npm install -g sylera-cli

# Initialize configuration
sylera init

# Set up repository
sylera config set repo https://github.com/your/repo
...
tracker = sylera.Tracker(repo_url="https://github.com/your/repo")
...
### Package Registries
- **PyPI**: `sylera-cli` for Python users
- **npm**: `sylera-cli` for Node.js users
- **Homebrew**: `sylera` for macOS users
...
### Development Setup
```bash
git clone https://github.com/your-org/sylera
cd sylera
pip install -e .
```
...
*Sylera: Open source project health and funding, made simple for every maintainer.*
