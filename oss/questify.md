# **Questify — Interview Preparation CLI**
...
**Questify** is an open-source CLI tool that generates personalized interview questions and practice sessions based on company information, job descriptions, and technical requirements. It helps developers prepare for technical interviews by creating contextual mock interviews and study guides.
...
Questify is a simple CLI tool that:
...
questify analyze "https://company.com/careers/backend-engineer" --output questions.md

# Create a practice session
questify practice --company "TechCorp" --role "Senior Backend" --duration 30

# Generate study guide
questify guide --company "StartupXYZ" --role "Full Stack" --output guide.md

# Interactive interview mode
questify interview --company "BigTech" --role "ML Engineer"

# Analyze job description from text
questify analyze-text "Senior Python developer with AWS experience" --output analysis.json
```
...
Users can configure Questify using a `config.yaml` file:
...
# Scraping settings
user_agent: "Questify Interview Prep Bot"
rate_limit: 1
...
For future LLM enhancement, Questify supports API key configuration:
...
# Or via config file
questify config set api_key "your-api-key-here"
```
...
**Questify** helps developers prepare for technical interviews by generating personalized questions and practice sessions based on real company information and job requirements.
