# **Educea** — *Simple Lesson Planning CLI*
...
Educea is a simple CLI tool that lets you create, organize, and manage lesson plans directly from your terminal. Perfect for teachers who want to streamline their lesson planning without complex tools.
...
```bash
# Install via npm
npm install -g educea-cli

# Install via pip
pip install educea-cli

# Install via cargo
cargo install educea-cli

# Basic usage
educea create "Math Lesson" --subject math --grade 5        # Create lesson
educea add-objective "Math Lesson" "Learn fractions"        # Add objective
educea add-activity "Math Lesson" "Group practice"          # Add activity
educea list --subject math                                  # List lessons
educea schedule "Math Lesson" 2024-01-15 09:00              # Schedule lesson
educea export "Math Lesson" --format pdf                    # Export lesson
educea template create "Science Lab"                        # Create template
educea report --week 2024-01-15                             # Weekly report
```
...
Create a config file at `~/.educea/config.json`:

```json
{
  "data_path": "~/.educea/data.json",
  "default_subject": "General",
  "default_grade": "Elementary",
  "export_format": "markdown",
  "auto_backup": true,
  "backup_path": "~/.educea/backups"
}
```
