# **GearNest** — *Simple Outdoor Gear Management CLI*
...
GearNest is a simple CLI tool that lets you manage outdoor gear, track equipment, and organize adventure planning directly from your terminal. Perfect for outdoor enthusiasts, gear managers, and anyone who wants to organize their outdoor equipment without complex applications.
...
```bash
# Install via npm
npm install -g gearnest-cli

# Install via pip
pip install gearnest-cli

# Install via cargo
cargo install gearnest-cli

# Basic usage
gearnest gear add "Tent" --category camping --brand "North Face" --model "Tent 2"  # Add gear
gearnest gear list --category camping                                            # List camping gear
gearnest gear update "Tent" --condition good                                     # Update condition
gearnest maintenance add "Tent" --type cleaning --date 2024-01-15               # Add maintenance
gearnest checklist create "Weekend Hike" --activity hiking                      # Create checklist
gearnest checklist add-item "Weekend Hike" "Tent"                               # Add item to checklist
gearnest checklist pack "Weekend Hike" "Tent"                                   # Mark as packed
gearnest export --format csv                                                     # Export gear data
gearnest report --output gear_report.html                                       # Generate report
gearnest stats                                                                   # Show gear statistics
```
...
Create a config file at `~/.gearnest/config.json`:

```json
{
  "data_path": "~/.gearnest/data.json",
