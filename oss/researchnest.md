# **ResearchNest** — *Simple Research Data Management CLI*
...
## **What is ResearchNest?**

ResearchNest is a simple CLI tool that lets you manage research data, track experiments, and organize your research workflow directly from your terminal. Perfect for researchers, students, and anyone who wants to organize their research without complex systems.
...
```bash
# Install via npm
npm install -g researchnest-cli

# Install via pip
pip install researchnest-cli

# Install via cargo
cargo install researchnest-cli

# Basic usage
researchnest project create "Machine Learning Study" --description "Research on ML algorithms"  # Create project
researchnest experiment add "ML Study" "Test Model A" --date 2024-01-15                         # Add experiment
researchnest dataset add "ML Study" "training_data.csv" --format csv                           # Add dataset
researchnest citation add "ML Study" "Deep Learning Paper" --authors "Smith, J." --year 2023   # Add citation
researchnest status "ML Study"                                                                 # Show project status
researchnest timeline "ML Study" --days 30                                                     # Show timeline
researchnest export "ML Study" --format pdf                                                    # Export project
researchnest report "ML Study" --output report.html                                            # Generate report
researchnest list --status active                                                              # List active projects
```
...
Create a config file at `~/.researchnest/config.json`:

```json
{
  "data_path": "~/.researchnest/data.json",
  "default_format": "csv",
  "auto_backup": true,
  "export_format": "markdown",
  "citation_style": "apa",
  "backup_path": "~/.researchnest/backups"
}
```
