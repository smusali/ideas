# **EduTrackly** — *Simple Student Progress Tracking CLI*
...
EduTrackly is a simple CLI tool that lets you track student progress, manage assignments, and monitor learning goals directly from your terminal. Perfect for educators, students, and anyone who wants to organize academic information without complex systems.
...
```bash
# Install via npm
npm install -g edutrackly-cli

# Install via pip
pip install edutrackly-cli

# Install via cargo
cargo install edutrackly-cli

# Basic usage
edutrackly student add "John Doe" john@example.com     # Add student
edutrackly course add "Math 101" "Basic Mathematics"   # Add course
edutrackly assignment add "Homework 1" --due 2024-01-15 # Add assignment
edutrackly grade "Homework 1" 85                       # Record grade
edutrackly progress --student "John Doe"               # View progress
edutrackly report --format csv                         # Export report
edutrackly goal add "Complete Math 101" --target 2024-06-01 # Set goal
```
...
Create a config file at `~/.edutrackly/config.json`:

```json
{
  "data_path": "~/.edutrackly/data.json",
