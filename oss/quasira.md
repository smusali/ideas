# **Quasira — LLM Cost Tracker & Policy Enforcer**
...
Quasira is a simple, open-source tool that monitors your LLM API usage, tracks costs, and enforces basic policies. It's designed to be built in 7 days by a single developer and can be easily published to package registries.
...
npm install -g quasira-cli
# or
pip install quasira-cli

# Initialize configuration
quasira init

# Set your API keys
quasira config set openai_key YOUR_OPENAI_KEY
quasira config set anthropic_key YOUR_ANTHROPIC_KEY
...
### Package Registries
- **npm**: `quasira-cli` for Node.js users
- **PyPI**: `quasira-cli` for Python users
- **Homebrew**: `quasira` for macOS users
- **Chocolatey**: `quasira` for Windows users
...
### Development Setup
```bash
git clone https://github.com/your-org/quasira
cd quasira
npm install
npm run dev
```
...
*Quasira: Simple LLM cost tracking for developers who care about their budget.*
