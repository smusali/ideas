...
Xylora is a command-line tool that generates structured feedback from interview transcripts. Upload interview text and get instant, professional feedback for candidates and interviewers.
...
```bash
# Via npm
npm install -g xylora

# Via pip
pip install xylora

# Via cargo
cargo install xylora
```
...
xylora feedback interview.txt

# Generate feedback with custom template
xylora feedback interview.txt --template engineering

# Output as JSON
xylora feedback interview.txt --format json
...
**Xylora**: Turn interview transcripts into actionable feedback in seconds.
