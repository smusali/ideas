# **Ferota** — *Simple Travel Planning CLI*
...
Ferota is a simple CLI tool that lets you plan trips, manage itineraries, and track travel expenses directly from your terminal. Perfect for travelers, business professionals, and anyone who wants to organize their travel information without complex applications.
...
```bash
# Install via npm
npm install -g ferota-cli

# Install via pip
pip install ferota-cli

# Install via cargo
cargo install ferota-cli

# Basic usage
ferota trip create "Paris Vacation" --start 2024-06-01 --end 2024-06-07  # Create trip
ferota add-flight "Paris Vacation" "JFK-CDG" --date 2024-06-01          # Add flight
ferota add-hotel "Paris Vacation" "Hotel ABC" --nights 6                # Add hotel
ferota add-expense "Paris Vacation" 150 "Food" --category dining        # Add expense
ferota itinerary "Paris Vacation" --date 2024-06-01                     # View itinerary
ferota expenses "Paris Vacation" --total                                 # Show expenses
ferota export "Paris Vacation" --format pdf                              # Export trip
ferota reminder add "Check-in flight" --date 2024-05-30                 # Add reminder
```
...
Create a config file at `~/.ferota/config.json`:

```json
{
  "data_path": "~/.ferota/data.json",
