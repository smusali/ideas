# **AIChat** — *Simple AI Chat CLI Tool*
...
AIChat is a simple CLI tool that lets you create, manage, and interact with AI chat sessions directly from your terminal. Perfect for developers who want to quickly test AI models, manage conversations, and build chat applications without complex setup.
...
# Install via cargo
cargo install aichat-cli

# Basic usage
aichat start                    # Start new conversation
aichat chat "Hello, AI!"        # Send message
aichat list                     # List conversations
aichat load <id>                # Load conversation
aichat export <id> --format json # Export conversation
```
...
Create a config file at `~/.aichat/config.json`:
