# **CourseGrid** — *Simple Course Management CLI*
...
CourseGrid is a simple CLI tool that lets you manage courses, track academic progress, and plan your educational journey directly from your terminal. Perfect for students, educators, and anyone who wants to organize their academic information without complex systems.
...
```bash
# Install via npm
npm install -g coursegrid-cli

# Install via pip
pip install coursegrid-cli

# Install via cargo
cargo install coursegrid-cli

# Basic usage
coursegrid course add "CS101" "Introduction to Programming" 3    # Add course
coursegrid grade "CS101" A                                       # Record grade
coursegrid assignment add "CS101" "Final Project" 2024-12-15     # Add assignment
coursegrid schedule "CS101" Monday 09:00 10:30 "Room 101"        # Schedule course
coursegrid progress                                              # Show progress
coursegrid gpa                                                   # Calculate GPA
coursegrid export --format csv                                   # Export data
coursegrid plan --credits 120                                    # Plan degree
coursegrid reminder add "Study for CS101 exam" --date 2024-12-10 # Add reminder
```
...
Create a config file at `~/.coursegrid/config.json`:

```json
{
  "data_path": "~/.coursegrid/data.json",
