...
Zestiq is a command-line tool that helps restaurants create, manage, and export their menus. No complex web interfaces - just simple commands to organize menu items, categories, and pricing.
...
```bash
# Via npm
npm install -g zestiq

# Via pip
pip install zestiq

# Via cargo
cargo install zestiq
```
...
zestiq init "Joe's Pizza"

# Add a category
zestiq category add "Pizzas" "Our signature pizzas"

# Add a menu item
zestiq item add "Margherita Pizza" --category "Pizzas" --price 14.99 --description "Fresh mozzarella, tomato sauce, basil"

# List all items
zestiq item list

# Export menu to PDF
zestiq export pdf menu.pdf
...
**Zestiq**: Simple menu management from the command line.
