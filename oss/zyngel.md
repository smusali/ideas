...
zyngel search "San Francisco" --date "this weekend"

# Find specific type of events
zyngel search "tech meetups" --location "New York" --radius 10

# Get events for today
zyngel today --location "Austin, TX"

# Search with filters
zyngel search "music" --date "next week" --price "free" --category "entertainment"

# Export to calendar
zyngel search "conference" --location "Seattle" --output calendar --file events.ics

# Get recommendations
zyngel recommend --location "Boston" --interests "tech,music,food"

# Check specific venue
zyngel venue "The Fillmore" --location "San Francisco"
```
...
# Or via config file
zyngel config set meetup_api_key "your-meetup-api-key"
zyngel config set eventbrite_api_key "your-eventbrite-api-key"
```
